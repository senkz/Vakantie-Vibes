...
import vakantievibes.client.pages.AanpassenGebruikerPage;
import vakantievibes.client.pages.AdminPage;
import vakantievibes.client.pages.BestemmingenPage;
...
import vakantievibes.client.pages.MijnBoekingenPage;
import vakantievibes.client.pages.RegistrerenGebruikerPage;
...
public class Entry implements EntryPoint {
	...
	public void onModuleLoad() {
			...
			public void onSelection(SelectionEvent<Integer> event) {
				...
				case 1:
					if(serviceImpl.getLoginUser() == null)
						p.add(new RegistrerenGebruikerPage(serviceImpl));
					else
						p.add(new AanpassenGebruikerPage(serviceImpl));
					break;
				case 2:
					p.add(new BestemmingenPage(serviceImpl));
					break;
				case 3:
					p.add(new MijnBoekingenPage(serviceImpl));
					break;
				case 4:
		...
		myTabBar.setTabEnabled(5, false);
		...
		serviceImpl.addReis(new Reis(new Date(System.currentTimeMillis()+5000000), new Date(System.currentTimeMillis()+50000000), "Historische momenten beleef je op deze reis", "Dit designhotel ligt in het centrum van Berlijn, op 2 minuten lopen van het historische Checkpoint Charlie en op 3 minuten van het metrostation Stadtmitte.", b2, new Adres("Duitsland", "Hotel Gat Point Charlie", "German street2", "532", "3434BG" , "04324325358"), 50.00));
		Gebruiker g1 = new Gebruiker("wim", Inloggen.hashWachtwoord("1234"), "Wim", "Frederiks", "wim@frederiks.com");
		Adres a1 = new Adres("Nederland","utrecht","nijenoord","2e","3432ED","9393939339");
		g1.setAdres(a1);
		Gebruiker g2 = new Gebruiker("michiel", Inloggen.hashWachtwoord("1234"), "Michiel", "Borkent", "michiel@borkent.com");
