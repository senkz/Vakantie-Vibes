...
public class AanpassenGebruikerPage extends FormPanel{
	...
	public AanpassenGebruikerPage(VakantieVibes sI){
		setStyleName("reis");
		serviceImpl = sI;
		...
		bpost.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				...
				if (! tbww.getText().equals("")){user.setWachtWoord(tbww.getText());}
