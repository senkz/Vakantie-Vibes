...
public class RegistrerenGebruikerPage extends FormPanel{
	...
	public RegistrerenGebruikerPage(VakantieVibes sI){
		serviceImpl = sI;
		setStyleName("reis");
		...
		bpost.addClickHandler(new ClickHandler(){
			...
			public void onClick(ClickEvent event) {
				...
				if (serviceImpl.zoekGebruiker(tbgb.getText()) != null) {
					p += "Gebruikersnaam is reeds in gebruik\n";
				}
				...
				if(p != "")
				{
					...
					Window.alert(g.getGebruikersNaam() + " is geregistreerd.");
				}
			}});
